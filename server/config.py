...
MANUAL_PAYMENT_ALIPAY_QR_IMAGE_URL = os.getenv(
    "MANUAL_PAYMENT_ALIPAY_QR_IMAGE_URL",
    MANUAL_PAYMENT_QR_IMAGE_URL,
)
MANUAL_PAYMENT_WECHAT_QR_IMAGE_URL = os.getenv("MANUAL_PAYMENT_WECHAT_QR_IMAGE_URL", "")
MANUAL_PAYMENT_ALIPAY_ACCOUNT_NAME = os.getenv(
    "MANUAL_PAYMENT_ALIPAY_ACCOUNT_NAME",
    MANUAL_PAYMENT_ACCOUNT_NAME,
)
MANUAL_PAYMENT_WECHAT_ACCOUNT_NAME = os.getenv(
...
BIKENGBAO_ASSET_UPLOAD_TOKEN = os.getenv("BIKENGBAO_ASSET_UPLOAD_TOKEN", "")
